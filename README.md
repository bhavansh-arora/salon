# VELVET Salon & Spa — Website Template

A premium, mobile-optimized, animated multi-page website built for salons, spas and beauty studios.

## Pages

- `index.html` — Home (3D WebGL hero, services preview, stats, testimonials, gallery preview)
...
- Three.js (CDN) for the animated 3D hero on the homepage
...
- Images: currently hotlinked from Unsplash — swap `src` attributes for your own salon photography before going live
